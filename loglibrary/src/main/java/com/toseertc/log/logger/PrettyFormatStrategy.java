package com.toseertc.log.logger;

import androidx.annotation.NonNull;
import androidx.annotation.Nullable;

import static com.toseertc.log.logger.Utils.checkNotNull;
...
public class PrettyFormatStrategy implements FormatStrategy {
    ...
    private void logContent(int logType, @Nullable String tag, @NonNull String chunk) {
        checkNotNull(chunk);
        // todo 占用cpu和内存较高,待优化,包括http的logcontent方法


        String[] lines = chunk.split(System.getProperty("line.separator"));
        for (String line : lines) {
            logChunk(logType, tag, HORIZONTAL_LINE + " " + chunk);
        }
    }
