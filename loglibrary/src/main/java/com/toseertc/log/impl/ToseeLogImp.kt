...
import com.toseertc.log.logger.AndroidLogAdapter
import com.toseertc.log.logger.FormatStrategy
import com.toseertc.log.logger.Logger
import com.toseertc.log.logger.PrettyFormatStrategy
import com.toseertc.log.utils.DateUtils
import com.toseertc.log.utils.ZipUtils
import java.io.File
import java.text.SimpleDateFormat
import java.util.*

class ToseeLogImp(private val duBLogConfig: ToseeLogConfig) : ToseeLogInterface {
    ...
    private fun initLogImp(duBLogConfig: ToseeLogConfig) {
