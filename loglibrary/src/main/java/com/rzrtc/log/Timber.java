...
public final class Timber {
  ...
  public  void plant(@NotNull Tree tree) {
    if (tree == null) {
  ...
  @SuppressWarnings("ConstantConditions") // Validating public API contract.
  public  void plant(@NotNull Tree... trees) {
    if (trees == null) {
  ...
  public  void uproot(@NotNull Tree tree) {
    synchronized (FOREST) {
  ...
  private  final List<Tree> FOREST = new ArrayList<>();
   volatile Tree[] forestAsArray = TREE_ARRAY_EMPTY;

  /** A {@link Tree} that delegates to all planted trees in the {@linkplain #FOREST forest}. */
  private  final Tree TREE_OF_SOULS = new Tree() {
